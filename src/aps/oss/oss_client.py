...
if TYPE_CHECKING:
    from .oss.oss_request_builder import OssRequestBuilder

class OssClient(BaseRequestBuilder):
    """
    The main entry point of the SDK, exposes the configuration and the fluent API.
    """
    def __init__(self,request_adapter: RequestAdapter) -> None:
        """
        Instantiates a new OssClient and sets the default values.
    ...
    @property
    def oss(self) -> OssRequestBuilder:
        """
        The oss property
        """
        from .oss.oss_request_builder import OssRequestBuilder

        return OssRequestBuilder(self.request_adapter, self.path_parameters)
