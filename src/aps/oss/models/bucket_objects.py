...
@dataclass
class Bucket_objects(AdditionalDataHolder, Parsable):
    """
    ...
    # The items property
    items: Optional[list[ObjectDetails]] = None
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> Bucket_objects:
        """
        Creates a new instance of the appropriate class based on discriminator value
        param parse_node: The parse node to use to read the discriminator value and create the object
        Returns: Bucket_objects
        """
    ...
    def get_field_deserializers(self,) -> dict[str, Callable[[ParseNode], None]]:
        ...
        fields: dict[str, Callable[[Any], None]] = {
            "items": lambda n : setattr(self, 'items', n.get_collection_of_object_values(ObjectDetails)),
