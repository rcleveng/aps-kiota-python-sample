...
@dataclass
class Bucket(AdditionalDataHolder, Parsable):
    """
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> Bucket:
        """
    ...
    def get_field_deserializers(self,) -> dict[str, Callable[[ParseNode], None]]:
        ...
        fields: dict[str, Callable[[Any], None]] = {
            ...
            "bucketOwner": lambda n : setattr(self, 'bucket_owner', n.get_str_value()),
            "createdDate": lambda n : setattr(self, 'created_date', n.get_str_value()),
    ...
    def serialize(self,writer: SerializationWriter) -> None:
        ...
        writer.write_str_value("bucketOwner", self.bucket_owner)
        writer.write_str_value("createdDate", self.created_date)
