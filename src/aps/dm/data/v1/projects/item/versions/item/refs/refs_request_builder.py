...
class RefsRequestBuilder(BaseRequestBuilder):
    """
    Builds and executes requests for operations under /data/v1/projects/{project_id}/versions/{version_id}/refs
    """
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/data/v1/projects/{project_id}/versions/{version_id}/refs{?filter%5Bextension%2Etype%5D*,filter%5Bid%5D*,filter%5Btype%5D*}", path_parameters)
    
    async def get(self,request_configuration: Optional[RequestConfiguration[RefsRequestBuilderGetQueryParameters]] = None) -> Optional[Refs]:
        """
        ...
        return await self.request_adapter.send_async(request_info, Refs, error_mapping)
