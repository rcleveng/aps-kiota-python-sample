...
class Item_EscapedRequestBuilder(BaseRequestBuilder):
    """
    Builds and executes requests for operations under /data/v1/projects/{project_id}/versions/{version_id}/item
    """
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/data/v1/projects/{project_id}/versions/{version_id}/item", path_parameters)
    ...
    @dataclass
    class Item_EscapedRequestBuilderGetRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
