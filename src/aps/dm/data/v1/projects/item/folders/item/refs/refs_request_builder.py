...
if TYPE_CHECKING:
    ...
    from ........models.folder_refs import FolderRefs
    from ........models.folder_refs400_error import FolderRefs400Error
    from ........models.folder_refs403_error import FolderRefs403Error
    from ........models.folder_refs404_error import FolderRefs404Error
...
class RefsRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/data/v1/projects/{project_id}/folders/{folder_id}/refs{?filter%5Bextension%2Etype%5D*,filter%5Bid%5D*,filter%5Btype%5D*}", path_parameters)
    
    async def get(self,request_configuration: Optional[RequestConfiguration[RefsRequestBuilderGetQueryParameters]] = None) -> Optional[FolderRefs]:
        """
        ...
        error_mapping: dict[str, type[ParsableFactory]] = {
            "400": FolderRefs400Error,
            "403": FolderRefs403Error,
            "404": FolderRefs404Error,
        }
        if not self.request_adapter:
            raise Exception("Http core is null") 
        from ........models.folder_refs import FolderRefs

        return await self.request_adapter.send_async(request_info, FolderRefs, error_mapping)
