...
class RefsRequestBuilder(BaseRequestBuilder):
    """
    Builds and executes requests for operations under /data/v1/projects/{project_id}/folders/{folder_id}/relationships/refs
    """
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/data/v1/projects/{project_id}/folders/{folder_id}/relationships/refs{?filter%5Bdirection%5D*,filter%5Bextension%2Etype%5D*,filter%5Bid%5D*,filter%5BrefType%5D*,filter%5Btype%5D*}", path_parameters)
