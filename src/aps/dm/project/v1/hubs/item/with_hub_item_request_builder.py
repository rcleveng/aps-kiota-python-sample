...
class WithHub_ItemRequestBuilder(BaseRequestBuilder):
    """
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/project/v1/hubs/{hub_id}", path_parameters)
    ...
    def with_url(self,raw_url: str) -> WithHub_ItemRequestBuilder:
        """
        ...
        return WithHub_ItemRequestBuilder(self.request_adapter, raw_url)
    ...
    @dataclass
    class WithHub_ItemRequestBuilderGetRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
