...
class LinksRequestBuilder(BaseRequestBuilder):
    """
    Builds and executes requests for operations under /projects/{project_id}/versions/{version_id}/relationships/links
    """
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/projects/{project_id}/versions/{version_id}/relationships/links", path_parameters)
