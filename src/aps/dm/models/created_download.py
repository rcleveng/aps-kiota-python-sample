...
if TYPE_CHECKING:
    from .created_download_data import CreatedDownload_data
    from .json_api_links_self import Json_api_links_self
    from .json_api_version import Json_api_version

@dataclass
class CreatedDownload(AdditionalDataHolder, Parsable):
    """
    ...
    data: Optional[list[CreatedDownload_data]] = None
    # The JSON API object.
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> CreatedDownload:
        """
        Creates a new instance of the appropriate class based on discriminator value
        param parse_node: The parse node to use to read the discriminator value and create the object
        Returns: CreatedDownload
        """
    ...
    def get_field_deserializers(self,) -> dict[str, Callable[[ParseNode], None]]:
        ...
        fields: dict[str, Callable[[Any], None]] = {
            "data": lambda n : setattr(self, 'data', n.get_collection_of_object_values(CreatedDownload_data)),
