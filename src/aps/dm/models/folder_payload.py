...
if TYPE_CHECKING:
    from .folder_payload_data import FolderPayload_data
    from .json_api_version import Json_api_version

@dataclass
class FolderPayload(AdditionalDataHolder, Parsable):
    """
    ...
    data: Optional[FolderPayload_data] = None
    # The JSON API object.
    jsonapi: Optional[Json_api_version] = None
    
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> FolderPayload:
        """
        Creates a new instance of the appropriate class based on discriminator value
        param parse_node: The parse node to use to read the discriminator value and create the object
        Returns: FolderPayload
        """
    ...
    def get_field_deserializers(self,) -> dict[str, Callable[[ParseNode], None]]:
        ...
        fields: dict[str, Callable[[Any], None]] = {
            "data": lambda n : setattr(self, 'data', n.get_object_value(FolderPayload_data)),
