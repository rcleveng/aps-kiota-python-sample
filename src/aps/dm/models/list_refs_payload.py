...
if TYPE_CHECKING:
    from .list_refs_payload_attributes import ListRefsPayload_attributes
    from .list_refs_payload_relationships import ListRefsPayload_relationships
    from .type_commands import Type_commands

@dataclass
class ListRefsPayload(AdditionalDataHolder, Parsable):
    """
    ...
    attributes: Optional[ListRefsPayload_attributes] = None
    # Contains a list of resources required for execution of the command.
    relationships: Optional[ListRefsPayload_relationships] = None
    # The type of this resource. Possible values are ``commands``.
    type: Optional[Type_commands] = None
    
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> ListRefsPayload:
        """
        Creates a new instance of the appropriate class based on discriminator value
        param parse_node: The parse node to use to read the discriminator value and create the object
        Returns: ListRefsPayload
        """
        if parse_node is None:
            raise TypeError("parse_node cannot be null.")
        return ListRefsPayload()
    ...
    def get_field_deserializers(self,) -> dict[str, Callable[[ParseNode], None]]:
        ...
        fields: dict[str, Callable[[Any], None]] = {
            "attributes": lambda n : setattr(self, 'attributes', n.get_object_value(ListRefsPayload_attributes)),
            "relationships": lambda n : setattr(self, 'relationships', n.get_object_value(ListRefsPayload_relationships)),
