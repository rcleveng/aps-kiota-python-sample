...
if TYPE_CHECKING:
    ...
    from .publish_model_attributes_extension import PublishModel_attributes_extension

@dataclass
class PublishModel_attributes(AdditionalDataHolder, Parsable):
    """
    Contains the properties of the responseto the PublishModel command.
    """
    ...
    extension: Optional[PublishModel_attributes_extension] = None
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> PublishModel_attributes:
        """
        Creates a new instance of the appropriate class based on discriminator value
        param parse_node: The parse node to use to read the discriminator value and create the object
        Returns: PublishModel_attributes
        """
        if parse_node is None:
            raise TypeError("parse_node cannot be null.")
        return PublishModel_attributes()
    ...
    def get_field_deserializers(self,) -> dict[str, Callable[[ParseNode], None]]:
        ...
        fields: dict[str, Callable[[Any], None]] = {
            "extension": lambda n : setattr(self, 'extension', n.get_object_value(PublishModel_attributes_extension)),
