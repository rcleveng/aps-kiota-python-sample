...
class Search(AdditionalDataHolder, Parsable):
    ...
    data: Optional[list[VersionData]] = None
    # Information on the latest versions of the items in this resource.
    included: Optional[list[ItemData]] = None
    # The JSON API object.
    ...
    def get_field_deserializers(self,) -> dict[str, Callable[[ParseNode], None]]:
        ...
        fields: dict[str, Callable[[Any], None]] = {
            "data": lambda n : setattr(self, 'data', n.get_collection_of_object_values(VersionData)),
            "included": lambda n : setattr(self, 'included', n.get_collection_of_object_values(ItemData)),
