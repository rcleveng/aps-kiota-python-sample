...
if TYPE_CHECKING:
    ...
    from .version_payload_data_relationships_refs_data_meta_extension import VersionPayload_data_relationships_refs_data_meta_extension

@dataclass
class VersionPayload_data_relationships_refs_data_meta(AdditionalDataHolder, Parsable):
    """
    ...
    extension: Optional[VersionPayload_data_relationships_refs_data_meta_extension] = None
    # The type of custom relationship. Will always be ``xrefs``.
    ref_type: Optional[Reftypes_xref] = None
    
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> VersionPayload_data_relationships_refs_data_meta:
        """
        Creates a new instance of the appropriate class based on discriminator value
        param parse_node: The parse node to use to read the discriminator value and create the object
        Returns: VersionPayload_data_relationships_refs_data_meta
        """
        if parse_node is None:
            raise TypeError("parse_node cannot be null.")
        return VersionPayload_data_relationships_refs_data_meta()
    ...
    def get_field_deserializers(self,) -> dict[str, Callable[[ParseNode], None]]:
        ...
        fields: dict[str, Callable[[Any], None]] = {
            ...
            "extension": lambda n : setattr(self, 'extension', n.get_object_value(VersionPayload_data_relationships_refs_data_meta_extension)),
