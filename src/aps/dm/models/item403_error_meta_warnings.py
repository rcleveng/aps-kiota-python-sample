...
@dataclass
class Item403Error_meta_warnings(AdditionalDataHolder, Parsable):
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> Item403Error_meta_warnings:
        """
        Creates a new instance of the appropriate class based on discriminator value
        param parse_node: The parse node to use to read the discriminator value and create the object
        Returns: Item403Error_meta_warnings
        """
        if parse_node is None:
            raise TypeError("parse_node cannot be null.")
        return Item403Error_meta_warnings()
