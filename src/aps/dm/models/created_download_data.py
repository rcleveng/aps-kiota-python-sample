...
if TYPE_CHECKING:
    from .created_download_data_attributes import CreatedDownload_data_attributes
    from .json_api_links_self import Json_api_links_self
    from .type_job import Type_job

@dataclass
class CreatedDownload_data(AdditionalDataHolder, Parsable):
    # Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.
    additional_data: dict[str, Any] = field(default_factory=dict)

    # Contains the properties that indicate the current status of the job.
    attributes: Optional[CreatedDownload_data_attributes] = None
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> CreatedDownload_data:
        """
        Creates a new instance of the appropriate class based on discriminator value
        param parse_node: The parse node to use to read the discriminator value and create the object
        Returns: CreatedDownload_data
        """
        if parse_node is None:
            raise TypeError("parse_node cannot be null.")
        return CreatedDownload_data()
    ...
    def get_field_deserializers(self,) -> dict[str, Callable[[ParseNode], None]]:
        ...
        fields: dict[str, Callable[[Any], None]] = {
            "attributes": lambda n : setattr(self, 'attributes', n.get_object_value(CreatedDownload_data_attributes)),
