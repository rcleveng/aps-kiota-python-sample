...
@dataclass
class DownloadData_relationships_storage_data(AdditionalDataHolder, Parsable):
    """
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> DownloadData_relationships_storage_data:
        """
        Creates a new instance of the appropriate class based on discriminator value
        param parse_node: The parse node to use to read the discriminator value and create the object
        Returns: DownloadData_relationships_storage_data
        """
        if parse_node is None:
            raise TypeError("parse_node cannot be null.")
        return DownloadData_relationships_storage_data()
