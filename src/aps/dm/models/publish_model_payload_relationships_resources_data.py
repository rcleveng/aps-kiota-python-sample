...
@dataclass
class PublishModelPayload_relationships_resources_data(AdditionalDataHolder, Parsable):
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> PublishModelPayload_relationships_resources_data:
        """
        Creates a new instance of the appropriate class based on discriminator value
        param parse_node: The parse node to use to read the discriminator value and create the object
        Returns: PublishModelPayload_relationships_resources_data
        """
        if parse_node is None:
            raise TypeError("parse_node cannot be null.")
        return PublishModelPayload_relationships_resources_data()
