...
if TYPE_CHECKING:
    from .list_items_payload_attributes import ListItemsPayload_attributes
    from .list_items_payload_relationships import ListItemsPayload_relationships
    from .type_commands import Type_commands

@dataclass
class ListItemsPayload(AdditionalDataHolder, Parsable):
    """
    ...
    attributes: Optional[ListItemsPayload_attributes] = None
    # Contains a list of resources required for execution of the command.
    relationships: Optional[ListItemsPayload_relationships] = None
    # The type of this resource. Possible values are ``commands``.
    type: Optional[Type_commands] = None
    
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> ListItemsPayload:
        """
        Creates a new instance of the appropriate class based on discriminator value
        param parse_node: The parse node to use to read the discriminator value and create the object
        Returns: ListItemsPayload
        """
        if parse_node is None:
            raise TypeError("parse_node cannot be null.")
        return ListItemsPayload()
    ...
    def get_field_deserializers(self,) -> dict[str, Callable[[ParseNode], None]]:
        ...
        fields: dict[str, Callable[[Any], None]] = {
            "attributes": lambda n : setattr(self, 'attributes', n.get_object_value(ListItemsPayload_attributes)),
            "relationships": lambda n : setattr(self, 'relationships', n.get_object_value(ListItemsPayload_relationships)),
