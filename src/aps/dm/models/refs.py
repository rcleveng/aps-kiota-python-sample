...
if TYPE_CHECKING:
    ...
    from .refs_data import Refs_data

@dataclass
class Refs(AdditionalDataHolder, Parsable):
    """
    ...
    data: Optional[list[Refs_data]] = None
    # The JSON API object.
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> Refs:
        """
    ...
    def get_field_deserializers(self,) -> dict[str, Callable[[ParseNode], None]]:
        ...
        fields: dict[str, Callable[[Any], None]] = {
            "data": lambda n : setattr(self, 'data', n.get_collection_of_object_values(Refs_data)),
