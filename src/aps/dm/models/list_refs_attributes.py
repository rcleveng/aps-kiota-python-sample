...
if TYPE_CHECKING:
    ...
    from .list_refs_attributes_extension import ListRefs_attributes_extension

@dataclass
class ListRefs_attributes(AdditionalDataHolder, Parsable):
    """
    ...
    extension: Optional[ListRefs_attributes_extension] = None
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> ListRefs_attributes:
        """
        Creates a new instance of the appropriate class based on discriminator value
        param parse_node: The parse node to use to read the discriminator value and create the object
        Returns: ListRefs_attributes
        """
        if parse_node is None:
            raise TypeError("parse_node cannot be null.")
        return ListRefs_attributes()
    ...
    def get_field_deserializers(self,) -> dict[str, Callable[[ParseNode], None]]:
        ...
        fields: dict[str, Callable[[Any], None]] = {
            "extension": lambda n : setattr(self, 'extension', n.get_object_value(ListRefs_attributes_extension)),
