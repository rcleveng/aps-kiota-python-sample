...
if TYPE_CHECKING:
    ...
    from .project_extension_with_schema_link_data import Project_extension_with_schema_link_data

@dataclass
class Project_extension_with_schema_link(AdditionalDataHolder, Parsable):
    """
    ...
    data: Optional[Project_extension_with_schema_link_data] = None
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> Project_extension_with_schema_link:
        """
        Creates a new instance of the appropriate class based on discriminator value
        param parse_node: The parse node to use to read the discriminator value and create the object
        Returns: Project_extension_with_schema_link
        """
        if parse_node is None:
            raise TypeError("parse_node cannot be null.")
        return Project_extension_with_schema_link()
    ...
    def get_field_deserializers(self,) -> dict[str, Callable[[ParseNode], None]]:
        ...
        fields: dict[str, Callable[[Any], None]] = {
            "data": lambda n : setattr(self, 'data', n.get_object_value(Project_extension_with_schema_link_data)),
