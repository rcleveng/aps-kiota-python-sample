...
if TYPE_CHECKING:
    from .folder_extension_with_schema_link_data import Folder_extension_with_schema_link_data
    from .json_api_link import Json_api_link

@dataclass
class Folder_extension_with_schema_link(AdditionalDataHolder, Parsable):
    """
    ...
    data: Optional[Folder_extension_with_schema_link_data] = None
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> Folder_extension_with_schema_link:
        """
        Creates a new instance of the appropriate class based on discriminator value
        param parse_node: The parse node to use to read the discriminator value and create the object
        Returns: Folder_extension_with_schema_link
        """
        if parse_node is None:
            raise TypeError("parse_node cannot be null.")
        return Folder_extension_with_schema_link()
    ...
    def get_field_deserializers(self,) -> dict[str, Callable[[ParseNode], None]]:
        ...
        fields: dict[str, Callable[[Any], None]] = {
            "data": lambda n : setattr(self, 'data', n.get_object_value(Folder_extension_with_schema_link_data)),
