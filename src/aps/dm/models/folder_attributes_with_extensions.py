...
if TYPE_CHECKING:
    from .folder_extension_with_schema_link import Folder_extension_with_schema_link

@dataclass
class FolderAttributesWithExtensions(AdditionalDataHolder, Parsable):
    """
    ...
    extension: Optional[Folder_extension_with_schema_link] = None
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> FolderAttributesWithExtensions:
        """
        Creates a new instance of the appropriate class based on discriminator value
        param parse_node: The parse node to use to read the discriminator value and create the object
        Returns: FolderAttributesWithExtensions
        """
        if parse_node is None:
            raise TypeError("parse_node cannot be null.")
        return FolderAttributesWithExtensions()
    ...
    def get_field_deserializers(self,) -> dict[str, Callable[[ParseNode], None]]:
        ...
        fields: dict[str, Callable[[Any], None]] = {
            ...
            "extension": lambda n : setattr(self, 'extension', n.get_object_value(Folder_extension_with_schema_link)),
