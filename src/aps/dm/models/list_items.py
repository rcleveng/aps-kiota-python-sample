...
if TYPE_CHECKING:
    from .list_items_attributes import ListItems_attributes
    from .list_items_relationships import ListItems_relationships
    from .type_commands import Type_commands
    from .version_data import VersionData

@dataclass
class ListItems(AdditionalDataHolder, Parsable):
    """
    ...
    # Contains the properties of the responseto the ListItems command.
    attributes: Optional[ListItems_attributes] = None
    ...
    relationships: Optional[ListItems_relationships] = None
    # The type of this resource. Possible values are ``commands``.
    type: Optional[Type_commands] = None
    
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> ListItems:
        """
    ...
    def get_field_deserializers(self,) -> dict[str, Callable[[ParseNode], None]]:
        ...
        fields: dict[str, Callable[[Any], None]] = {
            "attributes": lambda n : setattr(self, 'attributes', n.get_object_value(ListItems_attributes)),
            "id": lambda n : setattr(self, 'id', n.get_str_value()),
            "included": lambda n : setattr(self, 'included', n.get_collection_of_object_values(VersionData)),
            "relationships": lambda n : setattr(self, 'relationships', n.get_object_value(ListItems_relationships)),
