...
if TYPE_CHECKING:
    from .download_formats_data import DownloadFormats_data
    from .json_api_links_self import Json_api_links_self
    from .json_api_version import Json_api_version

@dataclass
class DownloadFormats(AdditionalDataHolder, Parsable):
    """
    ...
    data: Optional[DownloadFormats_data] = None
    # The JSON API object.
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> DownloadFormats:
        """
        Creates a new instance of the appropriate class based on discriminator value
        param parse_node: The parse node to use to read the discriminator value and create the object
        Returns: DownloadFormats
        """
    ...
    def get_field_deserializers(self,) -> dict[str, Callable[[ParseNode], None]]:
        ...
        fields: dict[str, Callable[[Any], None]] = {
            "data": lambda n : setattr(self, 'data', n.get_object_value(DownloadFormats_data)),
