...
if TYPE_CHECKING:
    ...
    from .storage_payload_data import StoragePayload_data

@dataclass
class StoragePayload(AdditionalDataHolder, Parsable):
    """
    ...
    data: Optional[StoragePayload_data] = None
    # The JSON API object.
    jsonapi: Optional[Json_api_version] = None
    
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> StoragePayload:
        """
    ...
    def get_field_deserializers(self,) -> dict[str, Callable[[ParseNode], None]]:
        ...
        fields: dict[str, Callable[[Any], None]] = {
            "data": lambda n : setattr(self, 'data', n.get_object_value(StoragePayload_data)),
