...
if TYPE_CHECKING:
    from .folder_attributes_with_extensions import FolderAttributesWithExtensions
    from .folder_data_relationships import FolderData_relationships
    from .json_api_links_self_and_web_view import Json_api_links_self_and_web_view
    from .type_folder import Type_folder

@dataclass
class FolderData(AdditionalDataHolder, Parsable):
    """
    ...
    attributes: Optional[FolderAttributesWithExtensions] = None
    ...
    relationships: Optional[FolderData_relationships] = None
    # The type of the resource. Possible values are ``folders``.
    type: Optional[Type_folder] = None
    
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> FolderData:
        """
    ...
    def get_field_deserializers(self,) -> dict[str, Callable[[ParseNode], None]]:
        ...
        fields: dict[str, Callable[[Any], None]] = {
            "attributes": lambda n : setattr(self, 'attributes', n.get_object_value(FolderAttributesWithExtensions)),
            "id": lambda n : setattr(self, 'id', n.get_str_value()),
            "links": lambda n : setattr(self, 'links', n.get_object_value(Json_api_links_self_and_web_view)),
            "relationships": lambda n : setattr(self, 'relationships', n.get_object_value(FolderData_relationships)),
