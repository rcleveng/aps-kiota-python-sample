...
@dataclass
class RelationshipRefs_included(ComposedTypeWrapper, Parsable):
    """
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> RelationshipRefs_included:
        """
        Creates a new instance of the appropriate class based on discriminator value
        param parse_node: The parse node to use to read the discriminator value and create the object
        Returns: RelationshipRefs_included
        """
        ...
        try:
            ...
            mapping_value = None
        result = RelationshipRefs_included()
