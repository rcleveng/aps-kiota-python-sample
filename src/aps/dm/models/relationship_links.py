...
if TYPE_CHECKING:
    ...
    from .relationship_links_data import RelationshipLinks_data

@dataclass
class RelationshipLinks(AdditionalDataHolder, Parsable):
    """
    ...
    data: Optional[list[RelationshipLinks_data]] = None
    # The JSON API object.
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> RelationshipLinks:
        """
    ...
    def get_field_deserializers(self,) -> dict[str, Callable[[ParseNode], None]]:
        ...
        fields: dict[str, Callable[[Any], None]] = {
            "data": lambda n : setattr(self, 'data', n.get_collection_of_object_values(RelationshipLinks_data)),
