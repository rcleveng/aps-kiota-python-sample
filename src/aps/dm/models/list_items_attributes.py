...
if TYPE_CHECKING:
    ...
    from .list_items_attributes_extension import ListItems_attributes_extension

@dataclass
class ListItems_attributes(AdditionalDataHolder, Parsable):
    """
    ...
    extension: Optional[ListItems_attributes_extension] = None
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> ListItems_attributes:
        """
        Creates a new instance of the appropriate class based on discriminator value
        param parse_node: The parse node to use to read the discriminator value and create the object
        Returns: ListItems_attributes
        """
        if parse_node is None:
            raise TypeError("parse_node cannot be null.")
        return ListItems_attributes()
    ...
    def get_field_deserializers(self,) -> dict[str, Callable[[ParseNode], None]]:
        ...
        fields: dict[str, Callable[[Any], None]] = {
            "extension": lambda n : setattr(self, 'extension', n.get_object_value(ListItems_attributes_extension)),
