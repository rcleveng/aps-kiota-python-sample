...
@dataclass
class ItemPayload_data_relationships_parent_data(AdditionalDataHolder, Parsable):
    """
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> ItemPayload_data_relationships_parent_data:
        """
        Creates a new instance of the appropriate class based on discriminator value
        param parse_node: The parse node to use to read the discriminator value and create the object
        Returns: ItemPayload_data_relationships_parent_data
        """
        if parse_node is None:
            raise TypeError("parse_node cannot be null.")
        return ItemPayload_data_relationships_parent_data()
