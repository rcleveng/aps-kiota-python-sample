...
if TYPE_CHECKING:
    from .check_permission_payload_attributes_extension_data import CheckPermissionPayload_attributes_extension_data
    from .type_commandtype_check_permission import Type_commandtype_CheckPermission

@dataclass
class CheckPermissionPayload_attributes_extension(AdditionalDataHolder, Parsable):
    """
    ...
    data: Optional[CheckPermissionPayload_attributes_extension_data] = None
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> CheckPermissionPayload_attributes_extension:
        """
        Creates a new instance of the appropriate class based on discriminator value
        param parse_node: The parse node to use to read the discriminator value and create the object
        Returns: CheckPermissionPayload_attributes_extension
        """
        if parse_node is None:
            raise TypeError("parse_node cannot be null.")
        return CheckPermissionPayload_attributes_extension()
    ...
    def get_field_deserializers(self,) -> dict[str, Callable[[ParseNode], None]]:
        ...
        fields: dict[str, Callable[[Any], None]] = {
            "data": lambda n : setattr(self, 'data', n.get_object_value(CheckPermissionPayload_attributes_extension_data)),
