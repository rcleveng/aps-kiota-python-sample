...
@dataclass
class FolderContents_data(ComposedTypeWrapper, Parsable):
    """
    Composed type wrapper for classes FolderData, ItemData
    """
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> FolderContents_data:
        """
        Creates a new instance of the appropriate class based on discriminator value
        param parse_node: The parse node to use to read the discriminator value and create the object
        Returns: FolderContents_data
        """
