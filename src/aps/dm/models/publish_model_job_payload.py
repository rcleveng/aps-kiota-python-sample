...
if TYPE_CHECKING:
    from .publish_model_job_payload_attributes import PublishModelJobPayload_attributes
    from .publish_model_job_payload_relationships import PublishModelJobPayload_relationships
    from .type_commands import Type_commands

@dataclass
class PublishModelJobPayload(AdditionalDataHolder, Parsable):
    """
    ...
    attributes: Optional[PublishModelJobPayload_attributes] = None
    ...
    relationships: Optional[PublishModelJobPayload_relationships] = None
    # The type of this resource. Possible values are ``commands``.
    type: Optional[Type_commands] = None
    
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> PublishModelJobPayload:
        """
        Creates a new instance of the appropriate class based on discriminator value
        param parse_node: The parse node to use to read the discriminator value and create the object
        Returns: PublishModelJobPayload
        """
        if parse_node is None:
            raise TypeError("parse_node cannot be null.")
        return PublishModelJobPayload()
    ...
    def get_field_deserializers(self,) -> dict[str, Callable[[ParseNode], None]]:
        ...
        fields: dict[str, Callable[[Any], None]] = {
            "attributes": lambda n : setattr(self, 'attributes', n.get_object_value(PublishModelJobPayload_attributes)),
            "id": lambda n : setattr(self, 'id', n.get_str_value()),
            "relationships": lambda n : setattr(self, 'relationships', n.get_object_value(PublishModelJobPayload_relationships)),
