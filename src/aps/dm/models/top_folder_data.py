...
if TYPE_CHECKING:
    ...
    from .top_folder_attributes_with_extensions import TopFolderAttributesWithExtensions
    from .top_folder_data_relationships import TopFolderData_relationships
    from .type_folder import Type_folder

@dataclass
class TopFolderData(AdditionalDataHolder, Parsable):
    """
    ...
    def get_field_deserializers(self,) -> dict[str, Callable[[ParseNode], None]]:
        ...
        fields: dict[str, Callable[[Any], None]] = {
            "attributes": lambda n : setattr(self, 'attributes', n.get_object_value(TopFolderAttributesWithExtensions)),
            "id": lambda n : setattr(self, 'id', n.get_str_value()),
            "links": lambda n : setattr(self, 'links', n.get_object_value(Json_api_links_self_and_web_view)),
            "relationships": lambda n : setattr(self, 'relationships', n.get_object_value(TopFolderData_relationships)),
