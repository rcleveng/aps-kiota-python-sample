...
if TYPE_CHECKING:
    from .modelderivative.modelderivative_request_builder import ModelderivativeRequestBuilder

class ModelDerivativeClient(BaseRequestBuilder):
    """
    The main entry point of the SDK, exposes the configuration and the fluent API.
    """
    def __init__(self,request_adapter: RequestAdapter) -> None:
        """
        Instantiates a new ModelDerivativeClient and sets the default values.
        ...
        if not self.request_adapter.base_url:
            self.request_adapter.base_url = "https://developer.api.autodesk.com"
        self.path_parameters["base_url"] = self.request_adapter.base_url
    
    @property
    def modelderivative(self) -> ModelderivativeRequestBuilder:
        """
        The modelderivative property
        """
        from .modelderivative.modelderivative_request_builder import ModelderivativeRequestBuilder

        return ModelderivativeRequestBuilder(self.request_adapter, self.path_parameters)
