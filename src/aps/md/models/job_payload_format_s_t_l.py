...
if TYPE_CHECKING:
    from .job_payload_format_advanced_s_t_l import JobPayloadFormatAdvancedSTL
    from .output_type import OutputType

@dataclass
class JobPayloadFormatSTL(AdditionalDataHolder, Parsable):
    """
    ...
    advanced: Optional[JobPayloadFormatAdvancedSTL] = None
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> JobPayloadFormatSTL:
        """
        Creates a new instance of the appropriate class based on discriminator value
        param parse_node: The parse node to use to read the discriminator value and create the object
        Returns: JobPayloadFormatSTL
        """
        if parse_node is None:
            raise TypeError("parse_node cannot be null.")
        return JobPayloadFormatSTL()
    ...
    def get_field_deserializers(self,) -> dict[str, Callable[[ParseNode], None]]:
        ...
        fields: dict[str, Callable[[Any], None]] = {
            "advanced": lambda n : setattr(self, 'advanced', n.get_object_value(JobPayloadFormatAdvancedSTL)),
