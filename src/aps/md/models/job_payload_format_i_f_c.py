...
if TYPE_CHECKING:
    from .job_payload_format_advanced_i_f_c import JobPayloadFormatAdvancedIFC
    from .output_type import OutputType

@dataclass
class JobPayloadFormatIFC(AdditionalDataHolder, Parsable):
    """
    ...
    advanced: Optional[JobPayloadFormatAdvancedIFC] = None
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> JobPayloadFormatIFC:
        """
        Creates a new instance of the appropriate class based on discriminator value
        param parse_node: The parse node to use to read the discriminator value and create the object
        Returns: JobPayloadFormatIFC
        """
        if parse_node is None:
            raise TypeError("parse_node cannot be null.")
        return JobPayloadFormatIFC()
    ...
    def get_field_deserializers(self,) -> dict[str, Callable[[ParseNode], None]]:
        ...
        fields: dict[str, Callable[[Any], None]] = {
            "advanced": lambda n : setattr(self, 'advanced', n.get_object_value(JobPayloadFormatAdvancedIFC)),
