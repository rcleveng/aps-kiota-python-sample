...
if TYPE_CHECKING:
    from .job_payload_format_advanced_o_b_j import JobPayloadFormatAdvancedOBJ
    from .output_type import OutputType

@dataclass
class JobPayloadFormatOBJ(AdditionalDataHolder, Parsable):
    """
    ...
    advanced: Optional[JobPayloadFormatAdvancedOBJ] = None
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> JobPayloadFormatOBJ:
        """
        Creates a new instance of the appropriate class based on discriminator value
        param parse_node: The parse node to use to read the discriminator value and create the object
        Returns: JobPayloadFormatOBJ
        """
        if parse_node is None:
            raise TypeError("parse_node cannot be null.")
        return JobPayloadFormatOBJ()
    ...
    def get_field_deserializers(self,) -> dict[str, Callable[[ParseNode], None]]:
        ...
        fields: dict[str, Callable[[Any], None]] = {
            "advanced": lambda n : setattr(self, 'advanced', n.get_object_value(JobPayloadFormatAdvancedOBJ)),
