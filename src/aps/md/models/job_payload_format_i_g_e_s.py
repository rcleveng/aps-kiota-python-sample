...
if TYPE_CHECKING:
    from .job_payload_format_advanced_i_g_e_s import JobPayloadFormatAdvancedIGES
    from .output_type import OutputType

@dataclass
class JobPayloadFormatIGES(AdditionalDataHolder, Parsable):
    """
    ...
    advanced: Optional[JobPayloadFormatAdvancedIGES] = None
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> JobPayloadFormatIGES:
        """
        Creates a new instance of the appropriate class based on discriminator value
        param parse_node: The parse node to use to read the discriminator value and create the object
        Returns: JobPayloadFormatIGES
        """
        if parse_node is None:
            raise TypeError("parse_node cannot be null.")
        return JobPayloadFormatIGES()
    ...
    def get_field_deserializers(self,) -> dict[str, Callable[[ParseNode], None]]:
        ...
        fields: dict[str, Callable[[Any], None]] = {
            "advanced": lambda n : setattr(self, 'advanced', n.get_object_value(JobPayloadFormatAdvancedIGES)),
