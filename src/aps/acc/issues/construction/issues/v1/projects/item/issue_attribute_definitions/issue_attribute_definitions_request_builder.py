...
if TYPE_CHECKING:
    from .......models.attr_definition_page import Attr_definition_page
    from .......models.data_type import DataType

class IssueAttributeDefinitionsRequestBuilder(BaseRequestBuilder):
    """
    Builds and executes requests for operations under /construction/issues/v1/projects/{projectId}/issue-attribute-definitions
    """
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/construction/issues/v1/projects/{projectId}/issue-attribute-definitions{?filter%5BcreatedAt%5D*,filter%5BdataType%5D*,filter%5BdeletedAt%5D*,filter%5BupdatedAt%5D*,limit*,offset*}", path_parameters)
    
    async def get(self,request_configuration: Optional[RequestConfiguration[IssueAttributeDefinitionsRequestBuilderGetQueryParameters]] = None) -> Optional[Attr_definition_page]:
        """
        ...
        Returns: Optional[Attr_definition_page]
        """
        ...
        return await self.request_adapter.send_async(request_info, Attr_definition_page, None)
    
    def to_get_request_information(self,request_configuration: Optional[RequestConfiguration[IssueAttributeDefinitionsRequestBuilderGetQueryParameters]] = None) -> RequestInformation:
        """
        Retrieves information about issue custom attributes (custom fields) for a project, including the custom attribute title, description and type.
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    def with_url(self,raw_url: str) -> IssueAttributeDefinitionsRequestBuilder:
        """
        Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
        param raw_url: The raw URL to use for the request builder.
        Returns: IssueAttributeDefinitionsRequestBuilder
        """
        if raw_url is None:
            raise TypeError("raw_url cannot be null.")
        return IssueAttributeDefinitionsRequestBuilder(self.request_adapter, raw_url)
    
    @dataclass
    class IssueAttributeDefinitionsRequestBuilderGetQueryParameters():
        """
        Retrieves information about issue custom attributes (custom fields) for a project, including the custom attribute title, description and type.
        """
        def get_query_parameter(self,original_name: str) -> str:
            ...
            if original_name == "filterdata_type":
                return "filter%5BdataType%5D"
    ...
    @dataclass
    class IssueAttributeDefinitionsRequestBuilderGetRequestConfiguration(RequestConfiguration[IssueAttributeDefinitionsRequestBuilderGetQueryParameters]):
        """
