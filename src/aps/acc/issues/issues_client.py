...
if TYPE_CHECKING:
    from .construction.construction_request_builder import ConstructionRequestBuilder

class IssuesClient(BaseRequestBuilder):
    """
    The main entry point of the SDK, exposes the configuration and the fluent API.
    """
    def __init__(self,request_adapter: RequestAdapter) -> None:
        """
        Instantiates a new IssuesClient and sets the default values.
    ...
    @property
    def construction(self) -> ConstructionRequestBuilder:
        """
        The construction property
        """
        from .construction.construction_request_builder import ConstructionRequestBuilder

        return ConstructionRequestBuilder(self.request_adapter, self.path_parameters)
